...
class tick_processor:
    ...
    def __init__(
        ...
        self.dwx.subscribe_symbols_bar_data(
            [["EURUSD", "M15"], ["GBPJPY", "M5"], ["AUDCAD", "M1"]]
        )
    ...
    def on_tick(self, symbol, bid, ask):
        ...
        if self.open_test_trades:
            if now > self.last_open_time + timedelta(seconds=3):
                ...
                self.dwx.open_order(
                    symbol=symbol, order_type=order_type, price=price, lots=0.5
                )
...
MT4_files_dir = (
    "/home/fortesenselabs/.wine/drive_c/Program Files/Metatrader 5/MQL5/Files"
)
