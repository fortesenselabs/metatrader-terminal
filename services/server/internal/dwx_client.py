...
class DWXClient:
    ...
    TODO: Implement the MT Error Handler
    """
    ...
    """Regularly checks the file for symbols data and triggers
    the event_handler.on_symbols_data() function.
    """
        ...
        while self.ACTIVE:
            ...
            if len(text.strip()) > 0 and text != self._last_symbols_data_str:
                ...
                if self.event_handler is not None:
                    ...
                    for symbol_id, symbol_data in self.symbols_data.items():
                        self.event_handler.on_symbols_data(symbol_id, symbol_data)
