...
from tradeflow.metatrader.v0.base import BaseClient
from tradeflow.metatrader.v0.helpers import interval_to_milliseconds, convert_ts_str, get_loop
from tradeflow.metatrader.v0.exceptions import (
    MetaTraderServerAPIException,
    MetaTraderServerRequestException,
    NotImplementedException,
)
from tradeflow.metatrader.v0.enums import HistoricalKlinesType



class MTClient(BaseClient):
    """
        MetaTrader Terminal Server Client 
    """
    ...
    def _handle_response(response: requests.Response):
        ...
        if not (200 <= response.status_code < 300):
            raise MetaTraderServerAPIException(response, response.status_code, response.text)
        try:
            return response.json()
        except ValueError:
            raise MetaTraderServerRequestException("Invalid Response: %s" % response.text)
    ...
    def get_products(self) -> Dict:
        ...
        :raises: MetaTraderServerRequestException, MetaTraderServerAPIException
    ...
    def create_order(self, **params):
        ...
        :raises: MetaTraderServerRequestException, MetaTraderServerAPIException, BinanceOrderException, BinanceOrderMinAmountException, BinanceOrderMinPriceException, BinanceOrderMinTotalException, BinanceOrderUnknownSymbolException, BinanceOrderInactiveSymbolException
    ...
    def get_system_status(self):
        ...
        :raises: MetaTraderServerAPIException
    ...
    def create_margin_order(self, **params):
        ...
        :raises: MetaTraderServerRequestException, MetaTraderServerAPIException, BinanceOrderException, BinanceOrderMinAmountException,
...
class AsyncClient(BaseClient):
    ...
    async def _handle_response(self, response: aiohttp.ClientResponse):
        ...
        if not str(response.status).startswith("2"):
            raise MetaTraderServerAPIException(response, response.status, await response.text())
        try:
            return await response.json()
        except ValueError:
            txt = await response.text()
            raise MetaTraderServerRequestException(f"Invalid Response: {txt}")
    ...
    get_products.__doc__ = MTClient.get_products.__doc__

    async def get_exchange_info(self) -> Dict:
        return await self._get("exchangeInfo", version=self.PRIVATE_API_VERSION)

    get_exchange_info.__doc__ = MTClient.get_exchange_info.__doc__
    ...
    get_symbol_info.__doc__ = MTClient.get_symbol_info.__doc__
    ...
    ping.__doc__ = MTClient.ping.__doc__

    async def get_server_time(self) -> Dict:
        return await self._get("time", version=self.PRIVATE_API_VERSION)

    get_server_time.__doc__ = MTClient.get_server_time.__doc__
    ...
    get_all_tickers.__doc__ = MTClient.get_all_tickers.__doc__
    ...
    get_historical_trades.__doc__ = MTClient.get_historical_trades.__doc__
    ...
    get_aggregate_trades.__doc__ = MTClient.get_aggregate_trades.__doc__
    ...
    aggregate_trade_iter.__doc__ = MTClient.aggregate_trade_iter.__doc__

    async def get_klines(self, **params) -> Dict:
        return await self._get("klines", data=params, version=self.PRIVATE_API_VERSION)

    get_klines.__doc__ = MTClient.get_klines.__doc__
    ...
    _klines.__doc__ = MTClient._klines.__doc__
    ...
    _get_earliest_valid_timestamp.__doc__ = MTClient._get_earliest_valid_timestamp.__doc__
    ...
    get_historical_klines.__doc__ = MTClient.get_historical_klines.__doc__
    ...
    _historical_klines.__doc__ = MTClient._historical_klines.__doc__
    ...
    get_historical_klines_generator.__doc__ = (
        MTClient.get_historical_klines_generator.__doc__
    )
    ...
    _historical_klines_generator.__doc__ = MTClient._historical_klines_generator.__doc__
    ...
    get_avg_price.__doc__ = MTClient.get_avg_price.__doc__
    ...
    get_ticker.__doc__ = MTClient.get_ticker.__doc__
    ...
    get_symbol_ticker.__doc__ = MTClient.get_symbol_ticker.__doc__
    ...
    get_orderbook_ticker.__doc__ = MTClient.get_orderbook_ticker.__doc__
    ...
    order_limit_buy.__doc__ = MTClient.order_limit_buy.__doc__
    ...
    get_account_status.__doc__ = MTClient.get_account_status.__doc__
    ...
    get_account_api_trading_status.__doc__ = (
        MTClient.get_account_api_trading_status.__doc__
    )
    ...
    get_account_api_permissions.__doc__ = MTClient.get_account_api_permissions.__doc__
    ...
    get_dust_assets.__doc__ = MTClient.get_dust_assets.__doc__
    ...
    get_asset_dividend_history.__doc__ = MTClient.get_asset_dividend_history.__doc__
    ...
    make_universal_transfer.__doc__ = MTClient.make_universal_transfer.__doc__
    ...
    query_universal_transfer_history.__doc__ = (
        MTClient.query_universal_transfer_history.__doc__
    )

    async def get_trade_fee(self, **params):
        return await self._request_margin_api(
            "get", "asset/tradeFee", True, data=params
        )

    get_trade_fee.__doc__ = MTClient.get_trade_fee.__doc__
    ...
    get_asset_details.__doc__ = MTClient.get_asset_details.__doc__
    ...
    withdraw.__doc__ = MTClient.withdraw.__doc__
    ...
    get_deposit_history.__doc__ = MTClient.get_deposit_history.__doc__
    ...
    get_withdraw_history.__doc__ = MTClient.get_withdraw_history.__doc__
    ...
    get_withdraw_history_id.__doc__ = MTClient.get_withdraw_history_id.__doc__
    ...
    get_deposit_address.__doc__ = MTClient.get_deposit_address.__doc__
    ...
    get_margin_account.__doc__ = MTClient.get_margin_account.__doc__
    ...
    get_isolated_margin_account.__doc__ = MTClient.get_isolated_margin_account.__doc__
    ...
    enable_isolated_margin_account.__doc__ = (
        MTClient.enable_isolated_margin_account.__doc__
    )
    ...
    create_isolated_margin_account.__doc__ = (
        MTClient.create_isolated_margin_account.__doc__
    )
    ...
    get_isolated_margin_symbol.__doc__ = MTClient.get_isolated_margin_symbol.__doc__
    ...
    get_all_isolated_margin_symbols.__doc__ = (
        MTClient.get_all_isolated_margin_symbols.__doc__
    )
    ...
    toggle_bnb_burn_spot_margin.__doc__ = MTClient.toggle_bnb_burn_spot_margin.__doc__
    ...
    get_bnb_burn_spot_margin.__doc__ = MTClient.get_bnb_burn_spot_margin.__doc__

    async def get_margin_price_index(self, **params):
        return await self._request_margin_api("get", "margin/priceIndex", data=params)

    get_margin_price_index.__doc__ = MTClient.get_margin_price_index.__doc__
    ...
    transfer_margin_to_spot.__doc__ = MTClient.transfer_margin_to_spot.__doc__
    ...
    transfer_spot_to_margin.__doc__ = MTClient.transfer_spot_to_margin.__doc__
    ...
    transfer_isolated_margin_to_spot.__doc__ = (
        MTClient.transfer_isolated_margin_to_spot.__doc__
    )
    ...
    transfer_spot_to_isolated_margin.__doc__ = (
        MTClient.transfer_spot_to_isolated_margin.__doc__
    )
    ...
    create_margin_loan.__doc__ = MTClient.create_margin_loan.__doc__
    ...
    repay_margin_loan.__doc__ = MTClient.repay_margin_loan.__doc__
    ...
    create_margin_order.__doc__ = MTClient.create_margin_order.__doc__
    ...
    cancel_margin_order.__doc__ = MTClient.cancel_margin_order.__doc__
    ...
    set_margin_max_leverage.__doc__ = MTClient.set_margin_max_leverage.__doc__
    ...
    get_margin_transfer_history.__doc__ = MTClient.get_margin_transfer_history.__doc__
    ...
    get_margin_loan_details.__doc__ = MTClient.get_margin_loan_details.__doc__
    ...
    get_staking_asset_us.__doc__ = MTClient.get_staking_asset_us.__doc__
    ...
    stake_asset_us.__doc__ = MTClient.stake_asset_us.__doc__
    ...
    unstake_asset_us.__doc__ = MTClient.unstake_asset_us.__doc__
    ...
    get_staking_balance_us.__doc__ = MTClient.get_staking_balance_us.__doc__
    ...
    get_staking_history_us.__doc__ = MTClient.get_staking_history_us.__doc__
    ...
    get_staking_rewards_history_us.__doc__ = (
        MTClient.get_staking_rewards_history_us.__doc__
    )
    ...
    async def futures_account_balance(self, **params):
        return await self._request_futures_api(
            "get", "balance", True, version=2, data=params
        )
    ...
    get_pay_trade_history.__doc__ = MTClient.get_pay_trade_history.__doc__
    ...
    get_convert_trade_history.__doc__ = MTClient.get_convert_trade_history.__doc__
    ...
    convert_request_quote.__doc__ = MTClient.convert_request_quote.__doc__
    ...
    convert_accept_quote.__doc__ = MTClient.convert_accept_quote.__doc__
